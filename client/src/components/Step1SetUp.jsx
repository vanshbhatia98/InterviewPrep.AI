...
function Step1SetUp({ onStart, onBack }) {
  ...
  try {
    const result = await axios.post(ServerUrl + "/api/interview/generate-questions", {role, experience, mode, resumeText,
    ...
    >
      <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
        <motion.div
          ...
          className='relative bg-gradient-to-br from-indigo-50 to-violet-100 p-12 flex flex-col justify-center'
        >
          <button onClick={onBack} className='absolute top-6 left-6 p-2 rounded-full hover:bg-indigo-200 transition'>
